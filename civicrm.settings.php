...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , getenv("CLEARDB_DATABASE_URL"));
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', getenv("JAWSDB_URL"));
  }
}
...
$civicrm_root = '/app/wordpress/wp-content/plugins/civicrm/civicrm/';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/app/wordpress/wp-content/uploads/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , getenv('SITE_URL'));
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', getenv('SECURE_AUTH_KEY'));
}
...
// define( 'CIVICRM_MAIL_LOG', '/app/wordpress/wp-content/uploads/civicrm/templates_c//mail.log');
// }
